...
public class V2_0_1__SetOriginAddVisitedForExistingKeys extends BaseJavaMigration {

  private static final String ORIGIN_COUNTRY_SYS_VAR = "ws.origin.country";

  private static final Logger logger =
      LoggerFactory.getLogger(V2_0_1__SetOriginAddVisitedForExistingKeys.class);
